...
<body>
  <div class="header">
    <div class="header-brand">
      ...
      <span class="header-brand-text">VenueOS AI · FIFA World Cup 2026 · Stadium Intelligence Platform</span>
    </div>
    <h1>${title}</h1>
  ...
  <div class="footer">
    <span>This report was automatically generated by the <span class="footer-brand">VenueOS AI Platform</span>. For internal use only.</span>
    <span>${date}</span>
  </div>
</body>
</html>`;
...
export const Reports: React.FC = () => {
  ...
  const handleDownload = (rep: typeof reportItems[0]) => {
    ...
    setTimeout(() => {
      ...
      triggerDownload(html, `venueos-${safeName}-${Date.now()}.html`);
      setExportingId(null);
    }, 800);
  };
